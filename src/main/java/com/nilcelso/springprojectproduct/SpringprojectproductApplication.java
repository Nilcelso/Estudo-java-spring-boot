package com.nilcelso.springprojectproduct;
...
import com.nilcelso.springprojectproduct.resources.CategoryResource;
...
public class SpringprojectproductApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringprojectproductApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		Product p3 = new Product(null,"PSS", 2800.00, cat1);
